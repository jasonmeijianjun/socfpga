...
#1.export toolchain
export ARCH=arm
export CROSS_COMPILE=./host_tools/gcc-linaro-arm-linux-gnueabihf-4.8-2014.04_linux/bin/arm-linux-gnueabihf-#
...
cp ./cv_soc_devkit_ghrd/software/spl_bsp/preloader-mkpimage.bin ./host_tools/sd_image/
...
cp ./u-boot.git/u-boot.bin  ./host_tools/sd_image/u-boot-socfpga_cyclone5.img
...
make dtbs
cd -
#zImage,u-boot.scr,soc_system.rbf,socfpga.dtb
rm ./host_tools/sd_image/zImage
rm ./host_tools/sd_image/socfpga.dtb
