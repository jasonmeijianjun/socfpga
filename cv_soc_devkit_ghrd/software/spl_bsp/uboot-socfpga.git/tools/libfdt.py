...
class fdt_header(_object):
    ...
    if _newclass:magic = _swig_property(_libfdt.fdt_header_magic_get, _libfdt.fdt_header_magic_set)
    ...
    if _newclass:totalsize = _swig_property(_libfdt.fdt_header_totalsize_get, _libfdt.fdt_header_totalsize_set)
    ...
    if _newclass:off_dt_struct = _swig_property(_libfdt.fdt_header_off_dt_struct_get, _libfdt.fdt_header_off_dt_struct_set)
    ...
    if _newclass:off_dt_strings = _swig_property(_libfdt.fdt_header_off_dt_strings_get, _libfdt.fdt_header_off_dt_strings_set)
    ...
    if _newclass:off_mem_rsvmap = _swig_property(_libfdt.fdt_header_off_mem_rsvmap_get, _libfdt.fdt_header_off_mem_rsvmap_set)
    __swig_setmethods__["version"] = _libfdt.fdt_header_version_set
    __swig_getmethods__["version"] = _libfdt.fdt_header_version_get
    if _newclass:version = _swig_property(_libfdt.fdt_header_version_get, _libfdt.fdt_header_version_set)
    ...
    if _newclass:last_comp_version = _swig_property(_libfdt.fdt_header_last_comp_version_get, _libfdt.fdt_header_last_comp_version_set)
    ...
    if _newclass:boot_cpuid_phys = _swig_property(_libfdt.fdt_header_boot_cpuid_phys_get, _libfdt.fdt_header_boot_cpuid_phys_set)
    ...
    if _newclass:size_dt_strings = _swig_property(_libfdt.fdt_header_size_dt_strings_get, _libfdt.fdt_header_size_dt_strings_set)
    ...
    if _newclass:size_dt_struct = _swig_property(_libfdt.fdt_header_size_dt_struct_get, _libfdt.fdt_header_size_dt_struct_set)
    def __init__(self): 
...
class fdt_reserve_entry(_object):
    ...
    if _newclass:address = _swig_property(_libfdt.fdt_reserve_entry_address_get, _libfdt.fdt_reserve_entry_address_set)
    __swig_setmethods__["size"] = _libfdt.fdt_reserve_entry_size_set
    __swig_getmethods__["size"] = _libfdt.fdt_reserve_entry_size_get
    if _newclass:size = _swig_property(_libfdt.fdt_reserve_entry_size_get, _libfdt.fdt_reserve_entry_size_set)
    def __init__(self): 
...
class fdt_node_header(_object):
    ...
    if _newclass:tag = _swig_property(_libfdt.fdt_node_header_tag_get, _libfdt.fdt_node_header_tag_set)
    __swig_setmethods__["name"] = _libfdt.fdt_node_header_name_set
    __swig_getmethods__["name"] = _libfdt.fdt_node_header_name_get
    if _newclass:name = _swig_property(_libfdt.fdt_node_header_name_get, _libfdt.fdt_node_header_name_set)
    def __init__(self): 
...
def fdt_off_dt_strings(*args):
  return _libfdt.fdt_off_dt_strings(*args)
fdt_off_dt_strings = _libfdt.fdt_off_dt_strings

def fdt_off_mem_rsvmap(*args):
  return _libfdt.fdt_off_mem_rsvmap(*args)
...
def fdt_last_comp_version(*args):
  return _libfdt.fdt_last_comp_version(*args)
fdt_last_comp_version = _libfdt.fdt_last_comp_version

def fdt_boot_cpuid_phys(*args):
  return _libfdt.fdt_boot_cpuid_phys(*args)
fdt_boot_cpuid_phys = _libfdt.fdt_boot_cpuid_phys

def fdt_size_dt_strings(*args):
  return _libfdt.fdt_size_dt_strings(*args)
fdt_size_dt_strings = _libfdt.fdt_size_dt_strings

def fdt_size_dt_struct(*args):
  return _libfdt.fdt_size_dt_struct(*args)
...
def fdt_offset_ptr_w(*args):
  return _libfdt.fdt_offset_ptr_w(*args)
fdt_offset_ptr_w = _libfdt.fdt_offset_ptr_w

def fdt_next_tag(*args):
  return _libfdt.fdt_next_tag(*args)
fdt_next_tag = _libfdt.fdt_next_tag

def fdt_next_node(*args):
  return _libfdt.fdt_next_node(*args)
...
def fdt_set_magic(*args):
  return _libfdt.fdt_set_magic(*args)
fdt_set_magic = _libfdt.fdt_set_magic

def fdt_set_totalsize(*args):
  return _libfdt.fdt_set_totalsize(*args)
fdt_set_totalsize = _libfdt.fdt_set_totalsize

def fdt_set_off_dt_struct(*args):
  return _libfdt.fdt_set_off_dt_struct(*args)
fdt_set_off_dt_struct = _libfdt.fdt_set_off_dt_struct

def fdt_set_off_dt_strings(*args):
  return _libfdt.fdt_set_off_dt_strings(*args)
fdt_set_off_dt_strings = _libfdt.fdt_set_off_dt_strings

def fdt_set_off_mem_rsvmap(*args):
  return _libfdt.fdt_set_off_mem_rsvmap(*args)
fdt_set_off_mem_rsvmap = _libfdt.fdt_set_off_mem_rsvmap

def fdt_set_version(*args):
  return _libfdt.fdt_set_version(*args)
fdt_set_version = _libfdt.fdt_set_version

def fdt_set_last_comp_version(*args):
  return _libfdt.fdt_set_last_comp_version(*args)
fdt_set_last_comp_version = _libfdt.fdt_set_last_comp_version

def fdt_set_boot_cpuid_phys(*args):
  return _libfdt.fdt_set_boot_cpuid_phys(*args)
fdt_set_boot_cpuid_phys = _libfdt.fdt_set_boot_cpuid_phys

def fdt_set_size_dt_strings(*args):
  return _libfdt.fdt_set_size_dt_strings(*args)
fdt_set_size_dt_strings = _libfdt.fdt_set_size_dt_strings

def fdt_set_size_dt_struct(*args):
  return _libfdt.fdt_set_size_dt_struct(*args)
fdt_set_size_dt_struct = _libfdt.fdt_set_size_dt_struct

def fdt_check_header(*args):
  return _libfdt.fdt_check_header(*args)
fdt_check_header = _libfdt.fdt_check_header

def fdt_move(*args):
  return _libfdt.fdt_move(*args)
...
def fdt_get_max_phandle(*args):
  return _libfdt.fdt_get_max_phandle(*args)
fdt_get_max_phandle = _libfdt.fdt_get_max_phandle

def fdt_num_mem_rsv(*args):
  return _libfdt.fdt_num_mem_rsv(*args)
fdt_num_mem_rsv = _libfdt.fdt_num_mem_rsv

def fdt_get_mem_rsv(*args):
  return _libfdt.fdt_get_mem_rsv(*args)
fdt_get_mem_rsv = _libfdt.fdt_get_mem_rsv

def fdt_subnode_offset(*args):
  return _libfdt.fdt_subnode_offset(*args)
...
def fdt_get_property(*args):
  return _libfdt.fdt_get_property(*args)
fdt_get_property = _libfdt.fdt_get_property

def fdt_get_property_w(*args):
  return _libfdt.fdt_get_property_w(*args)
fdt_get_property_w = _libfdt.fdt_get_property_w

def fdt_getprop(*args):
  return _libfdt.fdt_getprop(*args)
fdt_getprop = _libfdt.fdt_getprop

def fdt_getprop_w(*args):
  return _libfdt.fdt_getprop_w(*args)
fdt_getprop_w = _libfdt.fdt_getprop_w

def fdt_get_phandle(*args):
  return _libfdt.fdt_get_phandle(*args)
fdt_get_phandle = _libfdt.fdt_get_phandle

def fdt_get_alias(*args):
  return _libfdt.fdt_get_alias(*args)
fdt_get_alias = _libfdt.fdt_get_alias

def fdt_get_path(*args):
  return _libfdt.fdt_get_path(*args)
fdt_get_path = _libfdt.fdt_get_path

def fdt_supernode_atdepth_offset(*args):
  return _libfdt.fdt_supernode_atdepth_offset(*args)
fdt_supernode_atdepth_offset = _libfdt.fdt_supernode_atdepth_offset

def fdt_node_depth(*args):
  return _libfdt.fdt_node_depth(*args)
fdt_node_depth = _libfdt.fdt_node_depth

def fdt_parent_offset(*args):
  return _libfdt.fdt_parent_offset(*args)
fdt_parent_offset = _libfdt.fdt_parent_offset

def fdt_node_offset_by_prop_value(*args):
  return _libfdt.fdt_node_offset_by_prop_value(*args)
fdt_node_offset_by_prop_value = _libfdt.fdt_node_offset_by_prop_value

def fdt_node_offset_by_phandle(*args):
  return _libfdt.fdt_node_offset_by_phandle(*args)
fdt_node_offset_by_phandle = _libfdt.fdt_node_offset_by_phandle

def fdt_node_check_compatible(*args):
  return _libfdt.fdt_node_check_compatible(*args)
fdt_node_check_compatible = _libfdt.fdt_node_check_compatible

def fdt_node_offset_by_compatible(*args):
  return _libfdt.fdt_node_offset_by_compatible(*args)
fdt_node_offset_by_compatible = _libfdt.fdt_node_offset_by_compatible

def fdt_stringlist_contains(*args):
  return _libfdt.fdt_stringlist_contains(*args)
fdt_stringlist_contains = _libfdt.fdt_stringlist_contains

def fdt_stringlist_count(*args):
  return _libfdt.fdt_stringlist_count(*args)
fdt_stringlist_count = _libfdt.fdt_stringlist_count

def fdt_stringlist_search(*args):
  return _libfdt.fdt_stringlist_search(*args)
fdt_stringlist_search = _libfdt.fdt_stringlist_search

def fdt_stringlist_get(*args):
  return _libfdt.fdt_stringlist_get(*args)
...
def fdt_size_cells(*args):
  return _libfdt.fdt_size_cells(*args)
fdt_size_cells = _libfdt.fdt_size_cells

def fdt_setprop_inplace_u32(*args):
  return _libfdt.fdt_setprop_inplace_u32(*args)
fdt_setprop_inplace_u32 = _libfdt.fdt_setprop_inplace_u32

def fdt_setprop_inplace_u64(*args):
  return _libfdt.fdt_setprop_inplace_u64(*args)
fdt_setprop_inplace_u64 = _libfdt.fdt_setprop_inplace_u64

def fdt_setprop_inplace_cell(*args):
  return _libfdt.fdt_setprop_inplace_cell(*args)
fdt_setprop_inplace_cell = _libfdt.fdt_setprop_inplace_cell

def fdt_nop_property(*args):
  return _libfdt.fdt_nop_property(*args)
fdt_nop_property = _libfdt.fdt_nop_property

def fdt_nop_node(*args):
  return _libfdt.fdt_nop_node(*args)
fdt_nop_node = _libfdt.fdt_nop_node

def fdt_create(*args):
  return _libfdt.fdt_create(*args)
fdt_create = _libfdt.fdt_create

def fdt_resize(*args):
  return _libfdt.fdt_resize(*args)
fdt_resize = _libfdt.fdt_resize

def fdt_add_reservemap_entry(*args):
  return _libfdt.fdt_add_reservemap_entry(*args)
fdt_add_reservemap_entry = _libfdt.fdt_add_reservemap_entry

def fdt_finish_reservemap(*args):
  return _libfdt.fdt_finish_reservemap(*args)
fdt_finish_reservemap = _libfdt.fdt_finish_reservemap

def fdt_begin_node(*args):
  return _libfdt.fdt_begin_node(*args)
fdt_begin_node = _libfdt.fdt_begin_node

def fdt_property_u32(*args):
  return _libfdt.fdt_property_u32(*args)
...
def fdt_property_placeholder(*args):
  return _libfdt.fdt_property_placeholder(*args)
fdt_property_placeholder = _libfdt.fdt_property_placeholder

def fdt_end_node(*args):
  return _libfdt.fdt_end_node(*args)
fdt_end_node = _libfdt.fdt_end_node

def fdt_finish(*args):
  return _libfdt.fdt_finish(*args)
fdt_finish = _libfdt.fdt_finish

def fdt_create_empty_tree(*args):
  return _libfdt.fdt_create_empty_tree(*args)
fdt_create_empty_tree = _libfdt.fdt_create_empty_tree

def fdt_open_into(*args):
  return _libfdt.fdt_open_into(*args)
...
def fdt_add_mem_rsv(*args):
  return _libfdt.fdt_add_mem_rsv(*args)
fdt_add_mem_rsv = _libfdt.fdt_add_mem_rsv

def fdt_del_mem_rsv(*args):
  return _libfdt.fdt_del_mem_rsv(*args)
fdt_del_mem_rsv = _libfdt.fdt_del_mem_rsv

def fdt_set_name(*args):
  return _libfdt.fdt_set_name(*args)
fdt_set_name = _libfdt.fdt_set_name

def fdt_setprop(*args):
  return _libfdt.fdt_setprop(*args)
fdt_setprop = _libfdt.fdt_setprop

def fdt_setprop_u32(*args):
  return _libfdt.fdt_setprop_u32(*args)
fdt_setprop_u32 = _libfdt.fdt_setprop_u32

def fdt_setprop_u64(*args):
  return _libfdt.fdt_setprop_u64(*args)
fdt_setprop_u64 = _libfdt.fdt_setprop_u64

def fdt_setprop_cell(*args):
  return _libfdt.fdt_setprop_cell(*args)
fdt_setprop_cell = _libfdt.fdt_setprop_cell

def fdt_appendprop(*args):
  return _libfdt.fdt_appendprop(*args)
fdt_appendprop = _libfdt.fdt_appendprop

def fdt_appendprop_u32(*args):
  return _libfdt.fdt_appendprop_u32(*args)
fdt_appendprop_u32 = _libfdt.fdt_appendprop_u32

def fdt_appendprop_u64(*args):
  return _libfdt.fdt_appendprop_u64(*args)
...
def fdt_add_subnode(*args):
  return _libfdt.fdt_add_subnode(*args)
fdt_add_subnode = _libfdt.fdt_add_subnode

def fdt_del_node(*args):
  return _libfdt.fdt_del_node(*args)
fdt_del_node = _libfdt.fdt_del_node

def fdt_overlay_apply(*args):
  return _libfdt.fdt_overlay_apply(*args)
